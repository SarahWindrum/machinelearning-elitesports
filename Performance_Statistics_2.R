...
# Correlations with Score for Play Variables
performance_data_pairs = dplyr::select(performance_data, 'Score', 'Tries Scored', 'Tackles Made', 'Tackle Completion',
...
performance_data_pairs2 = dplyr::select(performance_data, 'Score', 'Kicks Inside 22', 
...
performance_data_pairs3 = dplyr::select(performance_data, 'Score', 'Total Rucks...58', 'Tries From Lineout', 'Tries From Scrum', 'Tries From Counter',
...
performance_data_pairs4 = dplyr::select(performance_data, 'Score', 'Pens Con at LO Maul',
...
performance_data_pairs5 = dplyr::select(performance_data, 'Score', 'Turnover Won Own Half', '1 Phase Possessions', '2 Phase Possessions', '3 Phase Possessions',
...
performance_data_pairs6 = dplyr::select(performance_data, 'Score', 'Touch Kick', 'Kick P1', 'Kick P2', 'Kick P3',
...
performance_data_pairs7 = dplyr::select(performance_data, 'Score', 'Carried Out of 22', 'Kicked Out of 22', 'Con Quick Rucks', 'Defensive Exits', 'Players Commited to DOOA', 'Offloads', 'Missed Tackles',
...
performance_data_pairs8 = dplyr::select(performance_data, 'Score', 'Foul Play - Foot Contact', 'Bad Pass', 'Rucks Lost', 'Forced Into Touch Own Half', 'Pen Conceded Own Half',
...
performance_data_pairs9 = dplyr::select(performance_data, 'Score', 'Attacking - Offside at Kick',
...
performance_data_pairs10 = dplyr::select(performance_data, 'Score', 'Delaying Kick Restart', 'Foul Play - Fighting', 'Foul Play - Dangerous Throw', 'Foul Play - Late Tackle', 'Foul Play - Mid Air Tackle', 
...
# Correlations with Tries Scored for Location Play Variables & Rucks ??


# Correlations with Tries Conceded for Location Play Variables & Rucks ??


# Correlations with Score for Location Variables 

location_data_red = dplyr::select(performance_data, 'Score', 'Pens in Red Zone', 'Rucks in Red Zone', 'Defenders Beaten in Red Zone', 'Linebreaks in Red Zone', 'Scrum Pens Won Red Zone',
...
location_data_grey = dplyr::select(performance_data, 'Score', 'Pens in Grey Zone', 'Rucks in Grey Zone', 'Defenders Beaten in Grey Zone', 'Linebreaks in Grey Zone',
...
location_data_amber = dplyr::select(performance_data, 'Score', 'Pens in Amber Zone', 'Rucks in Amber Zone', 'Defenders Beaten in Amber Zone', 'Linebreaks in Amber Zone',
...
location_data_green = dplyr::select(performance_data, 'Score', 'Pens in Green Zone', 'Green Zone Entries', 'Green Zone Points Scored %', 'Rucks in Green Zone', 'Defenders Beaten in Green Zone',
...
# Correlations with Score for Rucks 

ruck_data_1 = dplyr::select(performance_data, 'Score', '0 Rucks <3 Scrum', '0 Rucks <3 Try', '0 Rucks <3 Kick In Play', '0 Rucks <3 Pen Won', '0 Rucks <3 Pen Con', 
...
ruck_data_2 = dplyr::select(performance_data, 'Score', '1 Rucks <3 Pen Won', '1 Rucks <3 Pen Con', '1 Rucks <3 Kick Out of Play', '1 Rucks <3 Other', 
...
ruck_data_3 = dplyr::select(performance_data, 'Score', '2 Rucks <3 Other', '2 Rucks <3 Turnover (Scrum)', '2 Rucks <3 Kick Error', '2 Rucks <3 Own Lineout', 
...
ruck_data_4 = dplyr::select(performance_data, 'Score', '3 Rucks <3 Own Lineout', '3 Rucks <3 End of Play', '3 Rucks <3 Kick In Goal', '4+ Rucks <3 Scrum', 
